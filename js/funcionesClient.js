function consultar() {
    ...
    $.ajax (
               {
                        url          : 'https://gf5002f9c97cc42-disfraz.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client',
                        type         : 'GET',
                        dataType     : 'json',
    ...
    $.ajax (
                {
                    ...
                    url          : 'https://gf5002f9c97cc42-disfraz.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/' + codigo ,
                    type         : 'GET',
                    dataType     : 'json',
...
function cargar(idSeleccionado) {
    ...
    $.ajax (
               {
                        url          : 'https://gf5002f9c97cc42-disfraz.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/' + idSeleccionado,
                        type         : 'GET',
                        dataType     : 'json',
